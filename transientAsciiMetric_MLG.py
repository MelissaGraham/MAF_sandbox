...
# Built on the original transient metric with input ascii lightcurve
# Original authors: fbb@nyu.edu, svalenti@lcogt.net
# Updates by: mlg3k@uw.edu
...
__all__ = ['TransientAsciiMetric_MLG']


class TransientAsciiMetric_MLG(BaseMetric):
    ...
    """
    def __init__(self, asciifile, metricName='TransientAsciiMetric_MLG', mjdCol='expMJD',
        ...
        if self.dataout:
            super(TransientAsciiMetric_MLG, self).__init__(col=[self.mjdCol, self.m5Col, self.filterCol],
